    <div class="relative flex bg-white  w-full">
        ...
        <div class="absolute top-0 right-0   flex  items-start pt-3 justify-end w-1/2  pr-2 h-[120px]">
            ...
            @guest
                ...
                class="absolute hidden text-wrap transform translate-x-full transition-transform duration-500 ease-in-out overflow-y-auto min-w-[360px] md:min-w-[600px] md:max-h-[80vh] max-h-[95vh] min-h-[250px] z-50   flex-col justify-start text-start  top-0  right-0 bg-white shadow-md">
