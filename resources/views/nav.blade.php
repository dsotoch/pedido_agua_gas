    <div class="relative flex bg-white  w-full ">
        ...
        <div class="absolute top-0 right-0   flex  items-start pt-3 justify-end w-1/2  pr-2 h-[120px]">
            ...
            @guest
                ...
                class="fixed translate-x-full  hidden text-wrap transform rigth-0 transition-transform duration-500 ease-in-out overflow-y-auto min-w-[360px] md:min-w-[600px] md:max-h-[80vh] max-h-[95vh] min-h-[250px] z-50   flex-col justify-start text-start  top-20   bg-white shadow-md">
            ...
            @auth
                <div id="contenedor_login"
                class="fixed  translate-x-full hidden text-wrap transform  transition-transform duration-500 ease-in-out overflow-y-auto min-w-[360px] md:min-w-[600px] md:max-h-[80vh] max-h-[95vh] min-h-[250px] z-50   flex-col justify-start text-start  top-20  right-0 bg-white shadow-md">
