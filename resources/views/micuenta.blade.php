            ...
            <div class="flex flex-wrap  justify-center space-y-4 md:space-y-0 md:justify-start w-full"
                                    ...
                                    <div class="space-y-0 relative">
                                        ...
                                        @if (!empty($pedido->cupon))
                                            <div class="absolute -top-0 right-28 md:right-10 h-[50px] ">
                                                <div
                                                    class="relative bg-transparent w-[150px] h-[190px] text-color-titulos-entrega ">
                                                    <div>
                                                        <div
                                                            class="contenedor_cupon_aplicado z-50 -top-10 bg-green-400 left-0 hidden absolute  w-[250px] min-w-[250px] text-white p-2 rounded-md text-center">
                ...
                @else
                    @if ($pedidos->count() > 0)
                        @foreach ($pedidos as $pedido)
                            <div id="caja-{{ $pedido->id }}"
                                class="mi_cuenta_pedido w-[95%] md:w-[363px] md:p-[15px] p-0 flex flex-col justify-center items-center md:max-w-[363px]">
                                <div
                                        ...
                                        <div>
                                            <div>
                                                ...
                                                <div id="contador_fin-{{ $pedido->id }}"
                                                    class=" hidden  flex-col justify-end h-[35px]  text-[13px]  ">
                                                    <p>El contador de
                                                        tiempo. llegó a cero.</p>
                                                </div>
                                            </div>
                                            <script>
                                                (function() {
                                                    const pedidoFecha = new Date("{{ $pedido->fecha }}");
                                                    const duracionMaxima = {{ $pedido->empresa->tiempo ?? 20 }} * 60; // 20 minutos en segundos
