        ...
        <div class="flex w-full h-full">
            ...
            <div class="text-base m-4 ">
                <p class="text-color-text"><b><span
                            class="font-bold ">{{ $pedidos->count() > 0 ? $pedidos->count() : 0 }}</span></b> pedidos
        ...
        <div id="mi_cuenta_contenedor_pedidos_super">
            <div class="flex flex-wrap " id="mi_cuenta_contenedor_pedidos">
                                            ...
                                            <div class="flex space-x-2 ml-2 z-50">
                                                ...
                                                @else
                                                    ...
                                                    <button title="Anular pedido" data-id="{{ $pedido->id }}"
                                                        ...
                                                        <i class="fas fa-times-circle mr-2"></i> <!-- Ícono de anulación -->
                                                    </button>


                                                    <!-- Botón Acción Adicional -->
                                                    <button title="Aceptar Pedido"
                                                        class="flex items-center px-2 py-2  border-color-titulos-entrega text-color-titulos-entrega rounded shadow-md hover:bg-naranja  hover:text-white transform ">
                                                        <i class="fas fa-check mr-2"></i> <!-- Ícono de Font Awesome -->
                                                    </button>
                                                @endif
                                            </div>
                ...
                @else
                    @if ($pedidos->count() > 0)
                        @foreach ($pedidos as $pedido)
                            <div class="w-[363px] p-[15px] max-w-[363px]">
                                <div
        ...
        <div id="modalasignarrepartidor"
            ...
            <div class="bg-white rounded-lg shadow-lg p-6 w-full max-w-md">
                ...
                <div class="flex justify-between items-center border-b pb-3">
                    ...
                    <button class="text-red-500 hover:scale-150 transform" id="btncerrarmodalrepartidor">
                ...
                <form id="formAsignarRepartidor"
                    action="{{ route('pedido.asignarrepartidor', ['slug' => $empresa->dominio]) }}" method="POST"
                    class="mt-4">
                    @csrf
