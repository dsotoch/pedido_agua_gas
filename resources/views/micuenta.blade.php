    ...
    <div class="flex">
        <div class="pl-[20px] flex">
            ...
            <div class="max-w-[212px] w-[212px]">
                <input class="rounded-3xl bg-transparent border-color-text border p-3" type="search" autocomplete="off"
                    name="first_name" value="" placeholder="Buscar por nombres..." aria-label="Buscar por nombre">
            </div>
        ...
        <div class="text-base m-4 ">
            <p class="text-color-text"><b><span class="font-bold ">27</span></b> pedidos
                por visualizar.</p>
        </div>
    </div>
    <div class="grid mt-5 md:grid-cols-3 grid-cols-1">
        <!---Pedidos--->
        @if ($pedidos->count() > 0)
            @foreach ($pedidos as $pedido)
                <div class="w-[363px] max-w-[363px]">
                    <div
                        class="w-[333px] max-w-[333px] m-[15px] p-[20px] bg-color-tarjetas rounded-3xl text-color-titulos-entrega font-sans text-base">
                        <div class="space-y-0 relative">
                            ...
                            <div class=" flex items-center">
                                <div class="w-[17px] h-[17px] text-color-titulos-entrega opacity-80"><svg
                                        class="e-font-icon-svg e-fas-phone-alt" aria-hidden="true" viewBox="0 0 512 512"
                                        xmlns="http://www.w3.org/2000/svg">
                                        <path
                            ...
                            <div class="flex  min-h-[35px] mt-1 mb-1">
                                <div class="w-[18px] h-[18px] mt-2 mb-2"><svg
                                        class="text-color-titulos-entrega opacity-80 w-full h-full" aria-hidden="true" viewBox="0 0 288 512"
                                        xmlns="http://www.w3.org/2000/svg">
                                        <path
                            ...
                            <div class="flex items-center ">
                                ...
                                <div class="flex ml-6 space-x-2 items-center ">
                                    <div class="w-[17px] h-[17px] text-color-titulos-entrega opacity-80"><svg class=""
                            ...
                            <div class="flex items-center">
                                <div class="w-[17px] h-[17px] text-color-titulos-entrega opacity-80"><svg class=""
                                        aria-hidden="true" viewBox="0 0 640 512" xmlns="http://www.w3.org/2000/svg">
                                        <path
                            ...
                            <div class="flex  my-auto space-x-2">
                                <div class="w-[25px] h-[25px] text-color-titulos-entrega ">
                                    <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                                        id="Nautik_Delivery" x="0px" y="0px" width="25px" height="25px"
                            ...
                            <div class="flex my-auto space-x-2">
                                <div class="w-[25px] h-[25px]  text-color-titulos-entrega opacity-80"><svg
                                        ...
                                        viewBox="0 0 388.638 382.53" xml:space="preserve"
                                        class="text-color-titulos-entrega">
                                        <g>
                                ...
                                <div class="flex  justify-center h-[35px] "><b
                                        class="">{{ $pedido->pago ? $pedido->metodo : 'Pendiente de pago' }}</b>
                                </div>
                            </div>
                            <div>
                                    ...
                                    <div class="relative">
                                        <div
                                            ...
                                            <div class="relative">
                                                <div
                                                    ...
                                                    <p class="relative text-[14px] leading-[19.6px] pb-4">
                                                        ...
                                                        {{ $pedido->entregaPromociones->count() }} producto(s) incluido(s)
                                                        en este pedido.
                                                    </p>
                                                    <div
                                            ...
                                            <svg xmlns="http://www.w3.org/2000/svg"
                                                xmlns:xlink="http://www.w3.org/1999/xlink" id="Nautik_Delivery" x="0px"
            ...
            @endforeach
        @else
            <p class="tex-center text-base text-color-text">Aun No Has Realizado Ningun Pedido.</p>
        @endif
