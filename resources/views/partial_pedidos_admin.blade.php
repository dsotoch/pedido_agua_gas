<div class="flex flex-wrap  mi_cuenta_contenedor_pedidos">
    <!---Pedidos--->
    @if ($pedidos->count() > 0)
        @foreach ($pedidos as $pedido)
            <div class="mi_cuenta_pedido  p-[15px]  w-[363px] max-w-[363px]">
                <div
                    ...
                    <div class="space-y-0 relative">
                        <div class="flex justify-between">
                            ...
                            <div class="flex space-x-2 ml-2 z-50">
                                ...
                                <button title="Asignar repartidor"
                                    ...
                                    <i class="fas fa-user-plus mr-2"></i> <!-- Ícono de Font Awesome -->
                                </button>

                                <!-- Botón Acción Adicional -->
                                <button title="Cambiar de Estado"
                                    class="flex items-center px-2 py-2  border-color-titulos-entrega text-color-titulos-entrega rounded shadow-md hover:scale-150 transform ">
                                    <i class="fas fa-check mr-2"></i> <!-- Ícono de Font Awesome -->
                                </button>
                            </div>
                        ...
                        <div class="flex  min-h-[35px] mt-1 mb-1">
                            <div class="w-[18px] h-[18px] mt-2 mb-2"><svg
                                    class="text-color-titulos-entrega opacity-80 w-full h-full" aria-hidden="true"
                                ...
                                document.addEventListener('DOMContentLoaded', () => {
                                    (function() {
                                        ...
                                        const interval = setInterval(() => {
                                            ...
                                            const diferencia = Math.floor((ahora - pedidoFecha) /
                                            ...
                                            try {
                                                if (tiempoRestante <= 0) {
                                                    ...
                                                    document.getElementById('contador_fin-{{ $pedido->id }}').classList
                                                        .remove(
                                                            'hidden');
