                        ...
                        <li class="flex justify-between items-center p-4 usuariosadmin" data-id="{{ $item->id }}">
                            ...
                            @if ($item->tipo != 'admin')
                                <form class="formcambiarestado"
                                    action="{{ route('estado.usuario', ['id' => $item->persona->id]) }}" method="POST">
                                    @method('PUT')
        ...
        <div id="modalnuevousuario"
            ...
            <form action="{{ route('crear.usuario') }}" method="POST"
                ...
                <div class="p-2 space-y-4">
                    <div>
                        <label for="nombress" class="block text-sm font-medium text-color-titulos-entrega">Nombres</label>
                    ...
                    <div>
                        <label for="telefono" class="block text-sm font-medium text-color-titulos-entrega">Teléfono</label>
